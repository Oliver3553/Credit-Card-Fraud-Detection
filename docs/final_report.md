...
The model successfully identified over **5,800 fraudulent transactions** while maintaining a very low false positive rate.
...
Hypertuning had no significant impact showing Gradient Boosting was already sufficient.
